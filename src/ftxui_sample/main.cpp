...
// configuration step. It creates a namespace called `MyObjectARX`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MyObjectARX::cmake::project_name, MyObjectARX::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MyObjectARX::cmake::project_version);
      return EXIT_SUCCESS;
    }
